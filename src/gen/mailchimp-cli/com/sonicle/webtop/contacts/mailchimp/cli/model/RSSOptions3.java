...
import com.sonicle.webtop.contacts.mailchimp.cli.model.SendingSchedule;
...
public class RSSOptions3 {
  ...
  private SendingSchedule schedule = null;
  ...
  public RSSOptions3 feedUrl(String feedUrl) {
   ...
   * @return feedUrl
  **/
  @Schema(description = "The URL for the RSS feed.")
   ...
   * @return frequency
  **/
  @Schema(description = "The frequency of the RSS Campaign.")
  ...
  public RSSOptions3 schedule(SendingSchedule schedule) {
