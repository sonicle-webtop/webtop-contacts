 ...
 */
@Schema(description = "[RSS](https://mailchimp.com/help/share-your-blog-posts-with-mailchimp/) options, specific to an RSS campaign.")
...
public class RSSOptions {
  ...
  public RSSOptions feedUrl(String feedUrl) {
