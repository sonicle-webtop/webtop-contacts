 ...
 */
@Schema(description = "Details of abuse complaints for a specific list. An abuse complaint occurs when your recipient clicks to 'report spam' in their email program.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-22T12:55:27.492+02:00[Europe/Berlin]")
public class AbuseComplaint1 {
  @JsonProperty("id")
   ...
   * @return id
  **/
  @Schema(description = "The id for the abuse report")
   ...
   * @return campaignId
  **/
  @Schema(description = "The campaign id for the abuse report")
   ...
   * @return listId
  **/
  @Schema(description = "The unique id of the list for the abuse report.")
  ...
  **/
  ...
  public AbuseComplaint1 mergeFields(Map<String, Object> mergeFields) {
    this.mergeFields = mergeFields;
    return this;
  }

  public AbuseComplaint1 putMergeFieldsItem(String key, Object mergeFieldsItem) {
  ...
  **/
   ...
   * @return date
  **/
  @Schema(description = "Date for the abuse report")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AbuseComplaint1 abuseComplaint1 = (AbuseComplaint1) o;
    return Objects.equals(this.id, abuseComplaint1.id) &&
        Objects.equals(this.campaignId, abuseComplaint1.campaignId) &&
        Objects.equals(this.listId, abuseComplaint1.listId) &&
        Objects.equals(this.listIsActive, abuseComplaint1.listIsActive) &&
        Objects.equals(this.emailId, abuseComplaint1.emailId) &&
        Objects.equals(this.emailAddress, abuseComplaint1.emailAddress) &&
        Objects.equals(this.mergeFields, abuseComplaint1.mergeFields) &&
        Objects.equals(this.vip, abuseComplaint1.vip) &&
        Objects.equals(this.date, abuseComplaint1.date) &&
        Objects.equals(this._links, abuseComplaint1._links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, campaignId, listId, listIsActive, emailId, emailAddress, mergeFields, vip, date, _links);
  }
  ...
  public String toString() {
    ...
    sb.append("class AbuseComplaint1 {\n");
