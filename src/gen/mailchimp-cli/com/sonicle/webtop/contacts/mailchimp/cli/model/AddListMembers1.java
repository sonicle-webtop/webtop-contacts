...
public class AddListMembers1 {
  ...
  **/
   ...
   * @return status
  **/
  @Schema(required = true, description = "Subscriber's current status.")
  ...
  **/
   ...
   * @return vip
  **/
  @Schema(description = "[VIP status](https://mailchimp.com/help/view-and-edit-contact-languages/) for subscriber.")
  ...
  **/
  ...
  public AddListMembers1 marketingPermissions(List<MarketingPermission> marketingPermissions) {
    this.marketingPermissions = marketingPermissions;
    return this;
  }

  public AddListMembers1 addMarketingPermissionsItem(MarketingPermission marketingPermissionsItem) {
  ...
  **/
  ...
  public AddListMembers1 timestampSignup(DateTime timestampSignup) {
  ...
  **/
  ...
  public AddListMembers1 timestampOpt(DateTime timestampOpt) {
  ...
  **/
   ...
   * @return tags
  **/
  @Schema(description = "The tags that are associated with a member.")
