...
public class EcommercePromoCode {
  ...
  public EcommercePromoCode id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(required = true, description = "A unique identifier for the promo code. Restricted to UTF-8 characters with max length 50.")
  public String getId() {
    return id;
  }
   ...
   * @return code
  **/
  @Schema(example = "summersale", required = true, description = "The discount code. Restricted to UTF-8 characters with max length 50.")
  ...
  **/
  @Schema(example = "A url that applies promo code directly at checkout or a url that points to sale page or store url", required = true, description = "The url that should be used in the promotion campaign restricted to UTF-8 characters with max length 2000.")
  ...
  **/
  ...
  public EcommercePromoCode createdAtForeign(DateTime createdAtForeign) {
  ...
  **/
  ...
  public EcommercePromoCode updatedAtForeign(DateTime updatedAtForeign) {
