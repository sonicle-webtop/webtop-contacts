...
import com.sonicle.webtop.contacts.mailchimp.cli.model.ABTestOptions1Combinations;
...
public class ABTestOptions2 {
  @JsonProperty("winning_combination_id")
  private String winningCombinationId = null;

  @JsonProperty("winning_campaign_id")
  private String winningCampaignId = null;
  ...
  private List<ABTestOptions1Combinations> combinations = null;

   /**
   * ID for the winning combination.
   * @return winningCombinationId
  **/
  @Schema(description = "ID for the winning combination.")
  ...
  **/
  @Schema(description = "ID of the campaign that was sent to the remaining recipients based on the winning combination.")
  public String getWinningCampaignId() {
    return winningCampaignId;
  }

  public ABTestOptions2 winnerCriteria(WinnerCriteriaEnum winnerCriteria) {
  ...
  **/
  @Schema(description = "The combination that performs the best. This may be determined automatically by click rate, open rate, or total revenue -- or you may choose manually based on the reporting data you find the most valuable. For Multivariate Campaigns testing send_time, winner_criteria is ignored. For Multivariate Campaigns with 'manual' as the winner_criteria, the winner must be chosen in the Mailchimp web application.")
  ...
  public ABTestOptions2 waitTime(Integer waitTime) {
  ...
  **/
  ...
  public ABTestOptions2 testSize(Integer testSize) {
  ...
  **/
  ...
  public ABTestOptions2 subjectLines(List<String> subjectLines) {
    this.subjectLines = subjectLines;
    return this;
  }

  public ABTestOptions2 addSubjectLinesItem(String subjectLinesItem) {
  ...
  **/
  ...
  public ABTestOptions2 sendTimes(List<DateTime> sendTimes) {
    this.sendTimes = sendTimes;
    return this;
  }

  public ABTestOptions2 addSendTimesItem(DateTime sendTimesItem) {
  ...
  **/
  ...
  public ABTestOptions2 fromNames(List<String> fromNames) {
    this.fromNames = fromNames;
    return this;
  }

  public ABTestOptions2 addFromNamesItem(String fromNamesItem) {
  ...
  **/
  ...
  public ABTestOptions2 replyToAddresses(List<String> replyToAddresses) {
    this.replyToAddresses = replyToAddresses;
    return this;
  }

  public ABTestOptions2 addReplyToAddressesItem(String replyToAddressesItem) {
  ...
  **/
   ...
   * @return contents
  **/
  @Schema(description = "Descriptions of possible email contents. To set campaign contents, make a PUT request to /campaigns/{campaign_id}/content with the field 'variate_contents'.")
   ...
   * @return combinations
  **/
  @Schema(description = "Combinations of possible variables used to build emails.")
  public List<ABTestOptions1Combinations> getCombinations() {
    return combinations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ABTestOptions2 abTestOptions2 = (ABTestOptions2) o;
    return Objects.equals(this.winningCombinationId, abTestOptions2.winningCombinationId) &&
        Objects.equals(this.winningCampaignId, abTestOptions2.winningCampaignId) &&
        Objects.equals(this.winnerCriteria, abTestOptions2.winnerCriteria) &&
        Objects.equals(this.waitTime, abTestOptions2.waitTime) &&
        Objects.equals(this.testSize, abTestOptions2.testSize) &&
        Objects.equals(this.subjectLines, abTestOptions2.subjectLines) &&
        Objects.equals(this.sendTimes, abTestOptions2.sendTimes) &&
        Objects.equals(this.fromNames, abTestOptions2.fromNames) &&
        Objects.equals(this.replyToAddresses, abTestOptions2.replyToAddresses) &&
        Objects.equals(this.contents, abTestOptions2.contents) &&
        Objects.equals(this.combinations, abTestOptions2.combinations);
  }
  ...
  public String toString() {
    ...
    sb.append("class ABTestOptions2 {\n");
