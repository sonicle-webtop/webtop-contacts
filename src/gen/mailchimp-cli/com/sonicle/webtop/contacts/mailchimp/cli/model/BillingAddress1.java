...
public class BillingAddress1 {
   ...
   * @return name
  **/
  @Schema(example = "Freddie Chimpenheimer", description = "The name associated with an order's billing address.")
  ...
  **/
   ...
   * @return provinceCode
  **/
  @Schema(example = "GA", description = "The two-letter code for the province or state in the billing address.")
