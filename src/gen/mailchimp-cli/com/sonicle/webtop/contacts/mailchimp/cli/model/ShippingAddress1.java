...
public class ShippingAddress1 {
  ...
  **/
   ...
   * @return provinceCode
  **/
  @Schema(example = "GA", description = "The two-letter code for the province or state the order's shipping address is located in.")
   ...
   * @return postalCode
  **/
  @Schema(example = "30308", description = "The postal or zip code in the order's shipping address.")
   ...
   * @return country
  **/
  @Schema(example = "United States", description = "The country in the order's shipping address.")
  ...
  **/
   ...
   * @return company
  **/
  @Schema(description = "The company associated with an order's shipping address.")
