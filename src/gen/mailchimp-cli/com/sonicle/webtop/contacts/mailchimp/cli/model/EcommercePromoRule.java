...
public class EcommercePromoRule {
  ...
  public EcommercePromoRule id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(required = true, description = "A unique identifier for the promo rule. If Ecommerce platform does not support promo rule, use promo code id as promo rule id. Restricted to UTF-8 characters with max length 50.")
  public String getId() {
    return id;
  }
  ...
  **/
   ...
   * @return description
  **/
  @Schema(example = "Save BIG during our summer sale!", required = true, description = "The description of a promotion restricted to UTF-8 characters with max length 255.")
  ...
  public EcommercePromoRule startsAt(DateTime startsAt) {
  ...
  **/
   ...
   * @return amount
  **/
  @Schema(example = "0.5", required = true, description = "The amount of the promo code discount. If 'type' is 'fixed', the amount is treated as a monetary value. If 'type' is 'percentage', amount must be a decimal value between 0.0 and 1.0, inclusive.")
  ...
  **/
   ...
   * @return target
  **/
  @Schema(required = true, description = "The target that the discount applies to.")
  ...
  **/
  ...
  public EcommercePromoRule createdAtForeign(DateTime createdAtForeign) {
  ...
  **/
  ...
  public EcommercePromoRule updatedAtForeign(DateTime updatedAtForeign) {
