 ...
 */
@Schema(description = "List settings for the outreach")
...
public class List10 {
  ...
  public List10 listId(String listId) {
    this.listId = listId;
    return this;
  }
  ...
  **/
   ...
   * @return segmentText
  **/
  @Schema(description = "A description of the [segment](https://mailchimp.com/help/save-and-manage-segments/) used for the campaign. Formatted as a string marked up with HTML.")
  ...
  **/
  ...
  public List10 segmentOpts(SegmentOptions1 segmentOpts) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    List10 list10 = (List10) o;
    return Objects.equals(this.listId, list10.listId) &&
        Objects.equals(this.listIsActive, list10.listIsActive) &&
        Objects.equals(this.listName, list10.listName) &&
        Objects.equals(this.segmentText, list10.segmentText) &&
        Objects.equals(this.recipientCount, list10.recipientCount) &&
        Objects.equals(this.segmentOpts, list10.segmentOpts);
  }
