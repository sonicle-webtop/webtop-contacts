...
import com.sonicle.webtop.contacts.mailchimp.cli.model.Batch;
import com.sonicle.webtop.contacts.mailchimp.cli.model.BatchOperations;
import com.sonicle.webtop.contacts.mailchimp.cli.model.BatchesBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-22T12:55:27.492+02:00[Europe/Berlin]")public class BatchesApi {
   ...
   */
  public void deleteBatchesId(String batchId) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'batchId' is set
    if (batchId == null) {
      throw new ApiException(400, "Missing the required parameter 'batchId' when calling deleteBatchesId");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public BatchOperations getBatches(List<String> fields, List<String> excludeFields, Integer count, Integer offset) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    ...
    GenericType<BatchOperations> localVarReturnType = new GenericType<BatchOperations>() {};
   ...
   * @throws ApiException if fails to make API call
   */
  public Batch getBatchesId(String batchId, List<String> fields, List<String> excludeFields) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'batchId' is set
    if (batchId == null) {
      throw new ApiException(400, "Missing the required parameter 'batchId' when calling getBatchesId");
    }
    // create path and map variables
    String localVarPath = "/batches/{batch_id}"
      .replaceAll("\\{" + "batch_id" + "\\}", apiClient.escapeString(batchId.toString()));
    ...
    GenericType<Batch> localVarReturnType = new GenericType<Batch>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
   ...
   * @throws ApiException if fails to make API call
   */
  public Batch postBatches(BatchesBody body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling postBatches");
    }
    // create path and map variables
    String localVarPath = "/batches";
