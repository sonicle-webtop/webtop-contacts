...
public class SendingSchedule {
   ...
   * @return hour
  **/
  @Schema(description = "The hour to send the campaign in local time. Acceptable hours are 0-23. For example, '4' would be 4am in [your account's default time zone](https://mailchimp.com/help/set-account-defaults/).")
