...
public class AddListMembers2 {
  ...
  public enum StatusIfNewEnum {
    ...
    @JsonCreator
    public static StatusIfNewEnum fromValue(String text) {
  ...
  private StatusIfNewEnum statusIfNew = null;
   ...
   * @return emailAddress
  **/
  @Schema(required = true, description = "Email address for a subscriber. This value is required only if the email address is not already present on the list.")
   ...
   * @return statusIfNew
  **/
  @Schema(required = true, description = "Subscriber's status. This value is required only if the email address is not already present on the list.")
  ...
  **/
  ...
  public AddListMembers2 marketingPermissions(List<MarketingPermission> marketingPermissions) {
    this.marketingPermissions = marketingPermissions;
    return this;
  }

  public AddListMembers2 addMarketingPermissionsItem(MarketingPermission marketingPermissionsItem) {
  ...
  **/
  ...
  public AddListMembers2 timestampSignup(DateTime timestampSignup) {
  ...
  **/
  ...
  public AddListMembers2 timestampOpt(DateTime timestampOpt) {
