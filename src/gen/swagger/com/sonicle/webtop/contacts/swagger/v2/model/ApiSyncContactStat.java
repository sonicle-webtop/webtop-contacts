...
public class ApiSyncContactStat   {
   ...
   * Message ID (internal)
   **/
  public ApiSyncContactStat id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Revision tag
   **/
  public ApiSyncContactStat etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiSyncContactStat syncContactStat = (ApiSyncContactStat) o;
    return Objects.equals(this.id, syncContactStat.id) &&
        Objects.equals(this.etag, syncContactStat.etag);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiSyncContactStat {\n");
