	...
	tpl: [
		'<div class="wtcon-grid-cell-contactcolumn">',
			...
			'<div class="wtcon-contactcolumn-body">',
				'<span>',
					'<tpl if="email">',
					'<i class="<tpl if="isList">fas fa-list-ul<tpl else>far fa-envelope</tpl>" aria-hidden="true"></i>&nbsp;{email}',
					'</tpl>',
					'<tpl if="mobile">',
					'&nbsp;&nbsp;<i class="fas fa-mobile-alt" aria-hidden="true"></i>&nbsp;{mobile}',
					'<tpl else>',
					'<tpl if="telephone">',
					'&nbsp;&nbsp;<i class="fas fa-phone" aria-hidden="true"></i>&nbsp;{telephone}',
					'</tpl>',
					'</tpl>',
				'</span>',
			'</div>',
