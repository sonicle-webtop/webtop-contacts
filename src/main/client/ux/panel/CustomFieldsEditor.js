 ...
 */
Ext.define('Sonicle.webtop.contacts.ux.panel.CustomFieldsEditor', {
	//alternateClassName: 'WTA.ux.panel.CustomFieldsEditor',
	extend: 'Sonicle.webtop.contacts.ux.panel.CustomFieldsBase',
	...
	constructor: function(cfg) {
		...
		cfg.emptyItemTitle = WT.res('customFieldsPanel.empty.tit');
		cfg.emptyItemText = WT.res('customFieldsPanel.empty.txt');
		me.callParent([cfg]);
	},
