...
Ext.define('Sonicle.webtop.contacts.model.Contact', {
	...
	fields: [
		...
		WTF.field('mobile', 'string', true),
		WTF.field('pager1', 'string', true),
		WTF.field('pager2', 'string', true),
		WTF.field('email1', 'string', true),
		WTF.field('email2', 'string', true),
		WTF.field('email3', 'string', true),
		WTF.field('instantMsg1', 'string', true),
		WTF.field('instantMsg2', 'string', true),
		WTF.field('instantMsg3', 'string', true),
		...
		WTF.field('workTelephone1', 'string', true),
		...
		WTF.field('homeTelephone1', 'string', true),
