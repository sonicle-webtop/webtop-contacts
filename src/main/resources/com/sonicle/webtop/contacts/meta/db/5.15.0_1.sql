...
-- ----------------------------
DELETE FROM "core"."shares" WHERE "service_id" = 'com.sonicle.webtop.contacts' AND "key" = 'CATEGORY';
DELETE FROM "core"."roles_permissions" WHERE "service_id" = 'com.sonicle.webtop.contacts' AND "key" = 'CATEGORY_FOLDERITEMS@SHARE';
DELETE FROM "core"."roles_permissions" WHERE "service_id" = 'com.sonicle.webtop.contacts' AND "key" = 'CATEGORY_FOLDER@SHARE';
...
FROM "core"."shares"
WHERE "service_id" = 'com.sonicle.webtop.contacts' AND "key" = 'CATEGORY@ROOT';
...
FROM "core"."shares"
WHERE "service_id" = 'com.sonicle.webtop.contacts' AND "key" = 'CATEGORY@FOLDER' AND "instance" <> '*';
...
WHERE "shares"."user_uid" = sub."user_uid" AND "service_id" = 'com.sonicle.webtop.contacts' AND "key" = 'CATEGORY' AND "instance" = '*';
...
WHERE rp."service_id" = 'com.sonicle.webtop.contacts' AND rp."key" = 'CATEGORY@SHARE_ELEMENTS';
...
INNER JOIN "core"."shares" AS sh
ON rp."service_id" = sh."service_id" AND sh."key" = 'CATEGORY' AND rp."instance"::integer = sh."old_share_id"
WHERE rp."service_id" = 'com.sonicle.webtop.contacts' AND rp."key" = 'CATEGORY@SHARE_FOLDER';
...
INNER JOIN "core"."shares" AS sh
ON rp."service_id" = sh."service_id" AND sh."key" = 'CATEGORY' AND rp."instance"::integer = sh."old_share_id"
WHERE rp."service_id" = 'com.sonicle.webtop.contacts' AND rp."key" = 'CATEGORY@SHARE_ROOT';
...
-- ----------------------------
DELETE FROM "core"."user_settings" WHERE ("user_settings"."service_id" = 'com.sonicle.webtop.contacts') AND ("user_settings"."key" = 'category.origins.inactive');
INSERT INTO "core"."user_settings" ("domain_id", "user_id", "service_id", "key", "value")
SELECT
aggr."setting_domain_id",
aggr."setting_user_id",
'com.sonicle.webtop.contacts' as service_id,
...
WHERE cus."service_id" = 'com.sonicle.webtop.contacts' AND cus."key" = 'category.roots.inactive'
) cus_right ON cs."share_id" = cus_right."setting_share_id" AND cs."service_id" = 'com.sonicle.webtop.contacts' AND cs."key" = 'CATEGORY@ROOT'
