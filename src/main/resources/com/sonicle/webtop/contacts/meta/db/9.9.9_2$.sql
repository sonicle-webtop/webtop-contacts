...
CREATE OR REPLACE FUNCTION "contacts"."log_categories_changes"()
  RETURNS TRIGGER AS $BODY$BEGIN
	IF TG_OP = 'DELETE' THEN
		INSERT INTO "contacts"."categories_changes" ("domain_id", "user_id", "category_id", "change_timestamp", "change_type")
