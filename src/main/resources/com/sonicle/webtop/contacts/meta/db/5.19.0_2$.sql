...
CREATE OR REPLACE FUNCTION "contacts"."update_categories_history"()
  RETURNS TRIGGER AS $BODY$BEGIN
	IF TG_OP = 'DELETE' THEN
		INSERT INTO "contacts"."history_categories" ("domain_id", "user_id", "category_id", "change_timestamp", "change_type")
