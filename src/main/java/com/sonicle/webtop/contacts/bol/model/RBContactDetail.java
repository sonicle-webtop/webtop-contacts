...
public class RBContactDetail {
	...
	public RBContactDetail(CoreManager coreMgr, Category category, Contact contact, ContactPictureWithBytes picture) throws WTException {
		...
		this.workPager = contact.getPager1();
		this.homePager = contact.getPager2();
		this.workEmail = contact.getEmail1();
		this.homeEmail = contact.getEmail2();
		this.otherEmail = contact.getEmail3();
		this.workInstantMsg = contact.getInstantMsg1();
		this.homeInstantMsg = contact.getInstantMsg2();
		this.otherInstantMsg = contact.getInstantMsg3();
