...
public class Eas extends EasApi {
	...
	@Override
	public Response getMessagesStats(String folderId) {
		ContactsManager manager = getManager();
	...
	@Override
	public Response getMessage(String folderId, String id, Boolean picture) {
		ContactsManager manager = getManager();
	...
	public Response addMessage(String folderId, ApiEasSyncContactUpdate body) {
		...
		try {
			...
			newContact.setCategoryId(Integer.valueOf(folderId));
